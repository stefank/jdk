...
public class CompressedClassSpaceSize {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Minimum size is 1MB
        output = ProcessTools.executeLimitedTestJava("-XX:CompressedClassSpaceSize=0",
                                                     "-version");
        output.shouldContain("outside the allowed range")
              .shouldHaveExitValue(1);

        // Invalid size of -1 should be handled correctly
        output = ProcessTools.executeLimitedTestJava("-XX:CompressedClassSpaceSize=-1",
                                                     "-version");
        ...
        // Maximum size is 3GB
        output = ProcessTools.executeLimitedTestJava("-XX:CompressedClassSpaceSize=4g",
                                                     "-version");
        output.shouldContain("outside the allowed range")
              .shouldHaveExitValue(1);
        ...
        output = ProcessTools.executeLimitedTestJava("-XX:+UnlockDiagnosticVMOptions",
        ...
        output = ProcessTools.executeLimitedTestJava("-XX:-UseCompressedClassPointers",
                                                     "-XX:CompressedClassSpaceSize=1m",
                                                     "-version");
