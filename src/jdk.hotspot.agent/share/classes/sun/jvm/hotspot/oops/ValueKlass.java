...
// An ValueKlass is the VM level representation of a flattenable Java class.

public class ValueKlass extends InstanceKlass {
  ...
  public static class Members extends VMObject {
    ...
    private static synchronized void initialize(TypeDataBase db) throws WrongTypeException {
      ...
      size = type.getSize();
      payloadOffsetField = new CIntField(type.getCIntegerField("_layouts._payload_offset"), 0);
      nullMarkerOffsetField = new CIntField(type.getCIntegerField("_layouts._null_marker_offset"), 0);
    }
  ...
  private static synchronized void initialize(TypeDataBase db) throws WrongTypeException {
    ...
    Type type = db.lookupType("ValueKlass");
  }

  public ValueKlass(Address addr) {
    super(addr);
  }
