...
#ifndef OS_LINUX_GC_Z_LEGACY_ZLEGACYSYSCALL_LINUX_HPP
#define OS_LINUX_GC_Z_LEGACY_ZLEGACYSYSCALL_LINUX_HPP
...
#endif // OS_LINUX_GC_Z_LEGACY_ZLEGACYSYSCALL_LINUX_HPP
