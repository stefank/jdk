...
#ifndef CPU_PPC_GC_Z_LEGACY_ZLEGACYADDRESS_PPC_INLINE_HPP
#define CPU_PPC_GC_Z_LEGACY_ZLEGACYADDRESS_PPC_INLINE_HPP
...
#endif // CPU_PPC_GC_Z_LEGACY_ZLEGACYADDRESS_PPC_INLINE_HPP
