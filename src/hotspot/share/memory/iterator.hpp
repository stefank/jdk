...
class NMethodToOopClosure : public NMethodClosure {
 ...
 public:
  NMethodToOopClosure(OopClosure* cl) : _cl(cl) {}
  virtual void do_nmethod(nmethod* nm);
};

class UpdatingNMethodToOopClosure : public NMethodToOopClosure {
 public:
  ...
  UpdatingNMethodToOopClosure(OopClosure* cl) : NMethodToOopClosure(cl) {}
  virtual void do_nmethod(nmethod* nm);
};

class ClaimingNMethodToOopClosure : public NMethodToOopClosure {
 public:
  ClaimingNMethodToOopClosure(OopClosure* cl) : NMethodToOopClosure(cl) {}
  // Called for each code blob, but at most once per unique blob.

  virtual void do_nmethod(nmethod* nm);
};

class ClaimingUpdatingNMethodToOopClosure : public UpdatingNMethodToOopClosure {
 public:
  ClaimingUpdatingNMethodToOopClosure(OopClosure* cl) : UpdatingNMethodToOopClosure(cl) {}
  // Called for each code blob, but at most once per unique blob.
