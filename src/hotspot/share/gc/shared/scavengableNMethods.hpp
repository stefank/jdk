...
public:
  ...
  static void asserted_non_scavengable_nmethods_do(NMethodToOopClosure* cl) PRODUCT_RETURN;
...
private:
  ...
  static void verify_unlisted_nmethods(NMethodToOopClosure* cl) PRODUCT_RETURN;
};
