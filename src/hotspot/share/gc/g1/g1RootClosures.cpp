...
public:
  ...
  NMethodClosure* strong_codeblobs()      { return &_closures._codeblobs; }
  NMethodClosure* weak_codeblobs()        { return &_closures._codeblobs; }
};
...
public:
  ...
  NMethodClosure* strong_codeblobs()      { return &_strong._codeblobs; }
  NMethodClosure* weak_codeblobs()        { return &_weak._codeblobs; }
};
