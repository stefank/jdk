...
inline HeapWord* G1AllocRegion::par_allocate(HeapRegion* alloc_region, Words word_size) {
  Words temp;
...
inline HeapWord* G1AllocRegion::attempt_allocation(Words min_word_size,
                                                   Words desired_word_size,
                                                   Words* actual_word_size) {
...
inline HeapWord* G1AllocRegion::attempt_allocation_locked(Words word_size) {
  Words temp;
  return attempt_allocation_locked(word_size, word_size, &temp);
}

inline HeapWord* G1AllocRegion::attempt_allocation_locked(Words min_word_size,
                                                          Words desired_word_size,
                                                          Words* actual_word_size) {
...
inline HeapWord* G1AllocRegion::attempt_allocation_using_new_region(Words min_word_size,
                                                                    Words desired_word_size,
                                                                    Words* actual_word_size) {
  retire(true /* fill_up */);
...
inline HeapWord* G1AllocRegion::attempt_allocation_force(Words word_size) {
...
inline HeapWord* MutatorAllocRegion::attempt_retained_allocation(Words min_word_size,
                                                                 Words desired_word_size,
                                                                 Words* actual_word_size) {
