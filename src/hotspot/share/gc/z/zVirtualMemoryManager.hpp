...
private:
  ...
  ZVirtualMemoryRegistry _virtual_memory_reservation;
...
public:
  ...
  void initialize_partition(ZVirtualMemoryRegistry* partition, size_t size);
...
private:
  ZPerNUMA<ZVirtualMemoryRegistry> _partitions;
  ZVirtualMemoryRegistry           _multi_partition;
  bool                             _initialized;
