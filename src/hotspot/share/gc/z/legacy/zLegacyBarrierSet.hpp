...
#ifndef SHARE_GC_Z_LEGACY_ZLEGACYBARRIERSET_HPP
#define SHARE_GC_Z_LEGACY_ZLEGACYBARRIERSET_HPP
...
template<> struct BarrierSet::GetName<ZLegacy::ZBarrierSet> {
  static const BarrierSet::Name value = BarrierSet::ZLegacyBarrierSet;
};

template<> struct BarrierSet::GetType<BarrierSet::ZLegacyBarrierSet> {
  typedef ZLegacy::ZBarrierSet type;
};

#endif // SHARE_GC_Z_LEGACY_ZLEGACYBARRIERSET_HPP
