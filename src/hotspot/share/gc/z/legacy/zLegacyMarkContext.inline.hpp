...
#ifndef SHARE_GC_Z_LEGACY_ZLEGACYMARKCONTEXT_INLINE_HPP
#define SHARE_GC_Z_LEGACY_ZLEGACYMARKCONTEXT_INLINE_HPP

#include "gc/z/legacy/zLegacyMarkContext.hpp"
