...
#ifndef SHARE_GC_Z_LEGACY_ZLEGACYBARRIERSETASSEMBLER_HPP
#define SHARE_GC_Z_LEGACY_ZLEGACYBARRIERSETASSEMBLER_HPP
...
#include CPU_HEADER(gc/z/legacy/zLegacyBarrierSetAssembler)

#endif // SHARE_GC_Z_LEGACY_ZLEGACYBARRIERSETASSEMBLER_HPP
