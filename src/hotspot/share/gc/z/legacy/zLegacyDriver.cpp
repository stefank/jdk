...
#include "gc/z/legacy/zLegacyBreakpoint.hpp"
#include "gc/z/legacy/zLegacyCollectedHeap.hpp"
#include "gc/z/legacy/zLegacyDriver.hpp"
#include "gc/z/legacy/zLegacyHeap.inline.hpp"
#include "gc/z/legacy/zLegacyMessagePort.inline.hpp"
...
public:
  virtual VMOp_Type type() const {
    return VMOp_ZLegacyRelocateStart;
  }
