...
#ifndef SHARE_GC_Z_LEGACY_ZLEGACYFORWARDINGENTRY_HPP
#define SHARE_GC_Z_LEGACY_ZLEGACYFORWARDINGENTRY_HPP

#include "gc/z/legacy/zLegacyBitField.hpp"
...
template <>
struct PrimitiveConversions::Translate<ZLegacy::ZForwardingEntry> : public std::true_type {
  typedef ZLegacy::ZForwardingEntry Value;
  ...
  static Value recover(Decayed d) {
    ZLegacy::ZForwardingEntry entry;
    entry._entry = d;
    return entry;
  }
};

#endif // SHARE_GC_Z_LEGACY_ZLEGACYFORWARDINGENTRY_HPP
