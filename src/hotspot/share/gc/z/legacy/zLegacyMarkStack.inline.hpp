...
#ifndef SHARE_GC_Z_LEGACY_ZLEGACYMARKSTACK_INLINE_HPP
#define SHARE_GC_Z_LEGACY_ZLEGACYMARKSTACK_INLINE_HPP
...
#endif // SHARE_GC_Z_LEGACY_ZLEGACYMARKSTACK_INLINE_HPP
