...
#define VM_STRUCTS_Z_GENERATIONAL(nonstatic_field, volatile_nonstatic_field, static_field)           \
...
#define VM_INT_CONSTANTS_Z_GENERATIONAL(declare_constant, declare_constant_with_value)               \
...
#define VM_LONG_CONSTANTS_Z_GENERATIONAL(declare_constant)                                           \
...
#define VM_TYPES_Z_GENERATIONAL(declare_type, declare_toplevel_type, declare_integer_type)           \
