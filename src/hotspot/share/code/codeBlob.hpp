...
class UpcallStub: public RuntimeBlob {
 ...
 private:
  jobject _receiver;
  BytesInt _frame_data_offset;

  UpcallStub(const char* name, CodeBuffer* cb, int size, jobject receiver, BytesInt frame_data_offset);
 ...
 public:
  // Creation
  static UpcallStub* create(const char* name, CodeBuffer* cb, jobject receiver, BytesInt frame_data_offset);
