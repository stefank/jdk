...
public:
  ...
  static BytesInt last_Java_sp_offset()          { return byte_offset_of(JavaFrameAnchor, _last_Java_sp); }
  static BytesInt last_Java_pc_offset()          { return byte_offset_of(JavaFrameAnchor, _last_Java_pc); }
