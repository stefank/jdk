...
void MetaspaceShared::unmap_archive(FileMapInfo* mapinfo, ReservedSpace archive_space_rs) {
  ...
  if (mapinfo != nullptr) {
    ...
    mapinfo->unmap_stand_alone_region(MetaspaceShared::bm);
    mapinfo->set_is_mapped(false);
  }
}
...
void MetaspaceShared::initialize_shared_spaces() {
  ...
  static_mapinfo->unmap_stand_alone_region(MetaspaceShared::bm);
  ...
  if (dynamic_mapinfo != nullptr) {
    ...
    dynamic_mapinfo->unmap_stand_alone_region(MetaspaceShared::bm);
  }
